...
<div class="container-fluid g-0">
    <div class="row g-0">
        <!-- Coluna Esquerda com Imagem e Texto -->
        <div class="col-lg-6 d-none d-lg-block">
            <div class="left-column">
                <div class="left-content">
                    <img src="https://via.placeholder.com/180x60/0d6efd/FFFFFF?text=EMPRESA" alt="Logo" class="logo">
                    <h1>Cadastre sua empresa</h1>
                    <p>Simplifique a gestão do seu negócio com nossa plataforma completa. Cadastre-se agora e comece a aproveitar todos os benefícios.</p>
                    
                    <ul class="benefits-list list-unstyled">
                        <li><i class="fas fa-check-circle text-success me-2"></i> Gestão completa de clientes e fornecedores</li>
                        <li><i class="fas fa-check-circle text-success me-2"></i> Relatórios financeiros detalhados</li>
                        <li><i class="fas fa-check-circle text-success me-2"></i> Suporte especializado 24/7</li>
                        <li><i class="fas fa-check-circle text-success me-2"></i> Integração com sistemas contábeis</li>
                        <li><i class="fas fa-check-circle text-success me-2"></i> Plataforma segura e em conformidade com a LGPD</li>
                    </ul>
                </div>
            </div>
        </div>

        <!-- Coluna Direita com Formulário de Cadastro -->
        <div class="col-lg-6">
                        ...
                        <div class="card shadow-lg">
                            ...
                            <div class="card-body p-4">
                                ...
                                <form id="company-form" action="{{ route('companies.store') }}" method="POST" class="needs-validation" novalidate>
                                    ...
                                    <!-- Dados da Empresa -->
                                    <div class="mb-4">
                                        <h5 class="section-title text-primary"><i class="fas fa-info-circle me-2"></i>Dados da Empresa</h5>
                                    ...
                                    <!-- Contatos -->
                                    <div class="mb-4">
                                        <h5 class="section-title text-primary"><i class="fas fa-address-book me-2"></i>Contatos</h5>
                                    ...
                                    <!-- Endereço -->
                                    <div class="mb-4">
                                        <h5 class="section-title text-primary"><i class="fas fa-map-marker-alt me-2"></i>Endereço</h5>
                                    ...
                                    <!-- Segurança -->
                                    <div class="mb-4">
                                        <h5 class="section-title text-primary"><i class="fas fa-lock me-2"></i>Segurança</h5>
                                    ...
                                    <div class="mb-4">
                                        <h5 class="section-title text-primary"><i class="fas fa-info-circle me-2"></i>Informações Adicionais</h5>
