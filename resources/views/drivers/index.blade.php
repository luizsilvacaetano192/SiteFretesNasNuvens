...
function loadGoogleMapsAPI(callback) {
    ...
    script.src = `https://maps.googleapis.com/maps/api/js?key=AIzaSyCi-A7nNanHXhUiBS3_71XeLa6bE0aX9Ts&libraries=places&callback=initGoogleMaps`;
    script.async = true;
    script.defer = true;
...
// Modifique a função showDriversLocation para carregar a API primeiro
...
// Atualize a função geocodeAddress para verificar se a API está carregada
