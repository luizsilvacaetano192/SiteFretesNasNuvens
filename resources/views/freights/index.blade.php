    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('freights.dashboard') }}">Dashboard</a></li>
        ...
        if (freight.latitude && freight.longitude) {
            ...
            marker.bindPopup(`
                <div class="map-popup">
                    ...
                    <p><strong>Valor do frete:</strong> ${freight.formatted_value || 'N/A'}</p>
                     <p><strong>Valor para o motorista:</strong> ${freight.value_driver || 'N/A'}</p>
