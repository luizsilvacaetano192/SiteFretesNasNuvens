...
<body>
    ...
    <div class="sidebar">
        <div class="text-center mb-4">
            <img src="{{ asset('images/logo_fretes_nas_nuvens.png') }}" alt="Logo" class="img-fluid mt-3" style="max-height: 60px;">
        </div>
        ...
        <a href="/transfers"><i class="fas fa-money-check-alt"></i> Transferências</a>
