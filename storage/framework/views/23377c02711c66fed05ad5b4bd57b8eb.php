...
<div class="container-fluid px-4 py-5">
    <div class="row align-items-center mb-4">
        ...
        <div class="col-md-6 text-end">
            <a href="<?php echo e(route('shipments.create')); ?>" class="btn btn-primary btn-lg">
...
$(document).ready(function() {
    ...
    const table = $('#shipments-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "<?php echo e(route('shipments.index')); ?>",
            type: "GET",
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/luiz/SiteFretesNasNuvens/resources/views/shipments/index.blade.php ENDPATH**/ ?>