...
<div class="container py-5">
    <div class="text-center mt-4">
        <a href="<?php echo e(route('drivers.pushForm')); ?>" class="btn btn-primary">
...
<audio id="success-sound" src="<?php echo e(asset('sounds/success.mp3')); ?>"></audio>
<audio id="error-sound" src="<?php echo e(asset('sounds/error.mp3')); ?>"></audio>
...
$(document).ready(function () {
    ...
    const table = $('#messages-table').DataTable({
        ...
        order: [[5, 'desc']],
        ajax: {
            url: '<?php echo e(route("messages-push.list")); ?>',
            data: function (d) {
    ...
    $(document).on('click', '.resend-btn', function () {
        ...
        if (confirm('Deseja reenviar a notificação e limpar o erro?')) {
            $.ajax({
                ...
                error: function () {
                    showToast('Erro', 'Erro ao tentar reenviar.', 'danger');
                }
            });
        }
    });
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/luiz/SiteFretesNasNuvens/resources/views/drivers/messages/index.blade.php ENDPATH**/ ?>