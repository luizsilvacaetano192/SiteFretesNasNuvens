...
$(document).ready(function () {
    const table = $('#drivers-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "<?php echo e(route('drivers.data')); ?>",
        responsive: true,
        order: [[4, 'desc']],
        columns: [
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/luiz/SiteFretesNasNuvens/resources/views/drivers/index.blade.php ENDPATH**/ ?>