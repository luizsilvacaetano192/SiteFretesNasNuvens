<?php $__env->startSection('title', 'Lista de Cargas'); ?>
...
<div class="container-fluid px-4 py-5">
    <div class="row align-items-center mb-4">
        ...
        <div class="col-md-6 text-end">
            <a href="<?php echo e(route('shipments.cliente.create')); ?>" class="btn btn-primary btn-lg">
...
$(document).ready(function() {
    ...
    const table = $('#shipments-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "<?php echo e(route('shipments.cliente.index')); ?>",
            type: "GET",
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.cliente.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/luiz/SiteFretesNasNuvens/resources/views/shipments/cliente/index.blade.php ENDPATH**/ ?>