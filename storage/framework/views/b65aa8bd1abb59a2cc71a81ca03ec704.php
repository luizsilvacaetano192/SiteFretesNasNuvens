...
<head>
    ...
    <style>
        ...
        .card-header {
            background-color: #2A5BDD; /* Azul muito escuro */
...
<div class="main-container">
           ...
           <div class="card shadow-lg">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="form-logo-container">
                        <img src="<?php echo e(asset('images/logo_fretes_em_nuvens3.png')); ?>" alt="Logo Empresa" class="form-logo">
                    </div>
                </div>
                ...
                <div class="card-body p-4">
                    ...
                    <form id="company-form" action="<?php echo e(route('companies.cliente.store')); ?>" method="POST" class="needs-validation" novalidate>
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="name" name="name" class="form-control" required value="<?php echo e(old('name')); ?>" placeholder="Ex: Tech Solutions Ltda">
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="trading_name" name="trading_name" class="form-control" value="<?php echo e(old('trading_name')); ?>" placeholder="Ex: Tech Solutions">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-3 mt-1">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="cnpj" name="cnpj" class="form-control" required value="<?php echo e(old('cnpj')); ?>" placeholder="00.000.000/0000-00">
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="state_registration" name="state_registration" class="form-control" value="<?php echo e(old('state_registration')); ?>" placeholder="Opcional para MEI">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="phone" name="phone" class="form-control" required value="<?php echo e(old('phone')); ?>" placeholder="(00) 0000-0000">
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="whatsapp" name="whatsapp" class="form-control" value="<?php echo e(old('whatsapp')); ?>" placeholder="(00) 00000-0000">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-3 mt-1">
                                <div class="col-12">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="email" id="email" name="email" class="form-control" required value="<?php echo e(old('email')); ?>" placeholder="empresa@exemplo.com">
                                    </div>
                            ...
                            <div class="row g-3">
                                <div class="col-md-8">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="address" name="address" class="form-control bg-light" readonly required value="<?php echo e(old('address')); ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="number" name="number" class="form-control" required value="<?php echo e(old('number')); ?>" placeholder="Ex: 123">
                                    </div>
                            ...
                            <div class="row g-3 mt-1">
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="complement" name="complement" class="form-control" value="<?php echo e(old('complement')); ?>" placeholder="Ex: Sala 101">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="neighborhood" name="neighborhood" class="form-control bg-light" readonly required value="<?php echo e(old('neighborhood')); ?>">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="city" name="city" class="form-control bg-light" readonly required value="<?php echo e(old('city')); ?>">
                                    </div>
                                </div>
                                <div class="col-md-1">
                                    <label for="state" class="form-label">UF*</label>
                                    <div class="input-group mb-3">
                                        <input type="text" id="state" name="state" class="form-control bg-light text-uppercase" readonly required value="<?php echo e(old('state')); ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-3 mt-1">
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="zip_code" name="zip_code" class="form-control bg-light" readonly required value="<?php echo e(old('zip_code')); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="description" name="description" class="form-control" rows="3" placeholder="Descreva brevemente sua empresa"><?php echo e(old('description')); ?></textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="url" id="website" name="website" class="form-control" placeholder="https://www.suaempresa.com.br" value="<?php echo e(old('website')); ?>">
                                </div>
                            </div>
                        </div>
    ...
    <div class="image-column">
        <div class="logo-container">
            <img src="<?php echo e(asset('images/mascote-fretes-em-nuvens.png')); ?>" alt="Logo" class="logo">
        </div>
...
</html><?php /**PATH /home/luiz/SiteFretesNasNuvens/resources/views/companies/cliente/create.blade.php ENDPATH**/ ?>