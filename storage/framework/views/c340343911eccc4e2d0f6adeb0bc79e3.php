...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo e(asset('images/favicon.ico')); ?> sizes='any' " />
    ...
    <link rel="preload" href="<?php echo e(asset('images/logo_fretes_em_nuvens3.png')); ?>" as="image">
    <link rel="preload" href="<?php echo e(asset('images/mascote-fretes-em-nuvens.png')); ?>" as="image">
    ...
    <section class="hero">
        <div class="container">
            ...
            <div class="hero-image">
                <img src="<?php echo e(asset('images/mascote-fretes-em-nuvens.png')); ?>" loading="lazy" alt="Plataforma de fretes online Fretes em Nuvens">
            </div>
        </div>
    </section>
    ...
    <section class="highlights">
        <div class="container">
            <div class="highlight-item">
                <img src="<?php echo e(asset('images/icon-motoristas.png')); ?>" alt="Ícone de motoristas cadastrados" width="60">
                <h3>+5.000 Motoristas</h3>
                <p>Cadastrados e verificados em nossa plataforma</p>
            </div>
            <div class="highlight-item">
                <img src="<?php echo e(asset('images/icon-empresas.png')); ?>" alt="Ícone de empresas parceiras" width="60">
                <h3>+300 Empresas</h3>
                <p>Utilizando nossos serviços regularmente</p>
            </div>
            <div class="highlight-item">
                <img src="<?php echo e(asset('images/icon-fretes.png')); ?>" alt="Ícone de fretes realizados" width="60">
                <h3>+20.000 Fretes</h3>
   ...
   <section class="testimonials">
        ...
        <div class="testimonial-slider">
            ...
            <div class="testimonial" itemscope itemtype="https://schema.org/Review">
                ...
                <div class="quote" itemprop="reviewBody">
                    <img src="<?php echo e(asset('images/quote.png')); ?>" alt="Aspas" width="24">
                ...
                <div class="author" itemprop="author" itemscope itemtype="https://schema.org/Person">
                    <img src="<?php echo e(asset('images/client1.png')); ?>" alt="Foto de Carlos Mendes" width="60">
                    <div class="info">
            ...
            <div class="testimonial" itemscope itemtype="https://schema.org/Review">
                ...
                <div class="author" itemprop="author" itemscope itemtype="https://schema.org/Person">
                    <img src="<?php echo e(asset('images/client1.png')); ?>" alt="Foto de Roberto Silva" width="60">
                    <div class="info">
            ...
            <div class="testimonial" itemscope itemtype="https://schema.org/Review">
                ...
                <div class="author" itemprop="author" itemscope itemtype="https://schema.org/Person">
                    <img src="<?php echo e(asset('images/client1.png')); ?>" alt="Foto de Ana Paula Souza" width="60">
                    <div class="info">
    ...
    <div class="whatsapp-widget">
      <a href="https://wa.me/5541996077879?text=Olá,%20gostaria%20de%20mais%20informações%20sobre%20a%20plataforma%20Fretes%20em%20Nuvens" 
        ...
        <img src="<?php echo e(asset('images/icone-whatsapp.png')); ?>" alt="WhatsApp Fretes em Nuvens">
      </a>
    </div>
    ...
    <footer class="main-footer">
        <div class="container">
            <div class="footer-logo">
                <img src="<?php echo e(asset('images/logo_fretes_em_nuvens3.png')); ?>" alt="Fretes em Nuvens - Plataforma de Fretes Online" width="150">
                    ...
                    <ul>
                        ...
                        <li>
                            <div class="social-links">
                                <a href="#"><img src="<?php echo e(asset('images/icon-facebook.png')); ?>" alt="Facebook Fretes em Nuvens" width="24"></a> 
...
</html><?php /**PATH /home/luiz/SiteFretesNasNuvens/resources/views/institucional.blade.php ENDPATH**/ ?>